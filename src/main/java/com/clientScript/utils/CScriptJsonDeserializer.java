...
public class CScriptJsonDeserializer implements JsonDeserializer<Value> {

    public CScriptJsonDeserializer() {
        super();
    }
    
    @Override
    public Value deserialize(JsonElement json, java.lang.reflect.Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
