...
import com.clientScript.exception.ProcessedThrowStatement;
        ...
        expression.addLazyFunction("try", -1, (c, t, lv) -> {
            ...
            try {
                ...
                c.setVariable("_trace", (__c, __t) -> MapValue.wrap(ImmutableMap.of(
                    StringValue.of("stack"),
                    ListValue.wrap(ret.stack.stream().map(f -> ListValue.of(
                    ...
                    StringValue.of("locals"),
                    MapValue.wrap(ret.context.variables.entrySet().stream().filter(e -> !e.getKey().equals("_trace")).collect(Collectors.toMap(
