...
import com.clientScript.utils.CScriptJsonDeserializer;
...
import com.clientScript.value.LazyListValue;
...
public class DataStructures {
    public static void apply(Expression expression) {
        ...
        expression.addBinaryContextOperator(":", Operators.precedence.get("attribute~:"), true, true, false, (ctx, t, container, address) -> {
            ...
            if (t != Context.LVALUE)
                return ((ContainerValueInterface)container).get(address);
        ...
        expression.addUnaryFunction("decode_json", v -> {
            try {
                return new CScriptJsonDeserializer().deserialize(new JsonParser().parse(v.getString()), null, null);
