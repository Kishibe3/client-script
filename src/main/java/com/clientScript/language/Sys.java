...
import com.clientScript.utils.PerlinNoiseSampler;
import com.clientScript.utils.SimplexNoiseSampler;
    ...
    public static void apply(Expression expression) {
        ...
        expression.addUnaryFunction("number", v -> {
            if (v instanceof NumericValue) {
                ...
                if (num.isInteger())
                    return new NumericValue(num.getLong());
        ...
        expression.addFunction("str", lv -> {
            ...
            Matcher m = Sys.formatPattern.matcher(format);
        ...
        expression.addFunction("replace", lv -> {
            ...
            String data = lv.get(0).getString(), regex = lv.get(1).getString(), replacement = "";
            if (lv.size() == 3)
        ...
        expression.addFunction("perlin", lv -> {
            ...
            if (z instanceof NullValue)
                ...
                result = sampler.sample3d(NumericValue.asNumber(x).getDouble(), NumericValue.asNumber(y).getDouble(), NumericValue.asNumber(z).getDouble());
        ...
        expression.addContextFunction("time", 0, (c, t, lv) -> new NumericValue((System.nanoTime() / 1000.0) / 1000.0));

        expression.addContextFunction("unix_time", 0, (c, t, lv) -> new NumericValue(System.currentTimeMillis()));
        ...
        expression.addLazyFunction("profile_expr", 1, (c, t, lv) -> {
            ...
            long end = System.nanoTime() + 50000000L, it = 0;
        ...
        expression.addContextFunction("var", 1, (c, t, lv) -> expression.getOrSetAnyVariable(c, lv.get(0).getString()).evalValue(c));
